...
public interface TimeMark {
    ...
    TimeMark mo1566minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1567plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1709plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1708minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1567plusLRDsOJo(Duration.m1625unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1606isNegativeimpl(timeMark.mo1565elapsedNowUwyO8pc());
        }
