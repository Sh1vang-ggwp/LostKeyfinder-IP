...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1565elapsedNowUwyO8pc() {
        return Duration.m1608minusLRDsOJo(this.mark.mo1565elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1567plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1609plusLRDsOJo(this.adjustment, duration), null);
    }
}
