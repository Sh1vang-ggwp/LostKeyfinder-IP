...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1466getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m424constructorimpl = ((int) ULong.m424constructorimpl(j ^ ULong.m424constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m424constructorimpl2 = (m424constructorimpl + ((int) ULong.m424constructorimpl(j2 ^ ULong.m424constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m424constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m469toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m469toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
