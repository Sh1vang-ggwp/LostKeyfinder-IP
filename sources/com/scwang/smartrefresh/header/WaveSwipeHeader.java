...
public class WaveSwipeHeader extends InternalAbstract implements RefreshHeader {
    ...
    protected static final class VERTICAL_DRAG_THRESHOLD {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mProgress.getIntrinsicWidth(), MemoryConstants.GB);
        progressAnimationImageView.measure(makeMeasureSpec, makeMeasureSpec);
        waveView.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), MemoryConstants.GB));
    }
    ...
    public void onMoving(boolean z, float f, int i, int i2, int i3) {
        if (!z) {
            if (this.mLastFirstBounds == 0.0f || this.mState != RefreshState.None) {
                return;
            }
        ...
        if (f < 1.0f) {
            this.mProgress.setStartEndTrim(0.0f, Math.min(MAX_PROGRESS_ROTATION_RATE, max * MAX_PROGRESS_ROTATION_RATE));
    ...
    public void onReleased(RefreshLayout refreshLayout, int i, int i2) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.scwang.smartrefresh.header.WaveSwipeHeader.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                WaveSwipeHeader.this.mCircleView.setTranslationY(WaveSwipeHeader.this.mWaveView.getCurrentCircleCenterY() + (r4.getHeight() / 2.0f));
            }
        });
        ofFloat.start();
    }
