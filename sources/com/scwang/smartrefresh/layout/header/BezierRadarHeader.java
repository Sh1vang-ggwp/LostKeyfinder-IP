...
public class BezierRadarHeader extends InternalAbstract implements RefreshHeader {
    ...
    protected void drawWave(Canvas canvas, int i) {
        ...
        float f = i;
        path.quadTo(i2, this.mWaveHeight + r3, f, this.mWaveTop);
    ...
    protected void drawDot(Canvas canvas, int i, int i2) {
        if (this.mDotAlpha > 0.0f) {
            ...
            while (i3 < 7) {
                float f8 = (i3 + f3) - 4.0f;
                this.mPaint.setAlpha((int) (this.mDotAlpha * (f3 - ((Math.abs(f8) / 7.0f) * f6)) * 255.0f * (1.0d - (1.0d / Math.pow((px2dp / 800.0d) + 1.0d, 15.0d)))));
