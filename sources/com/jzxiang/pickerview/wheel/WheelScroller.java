...
public class WheelScroller {
    ...
    private Handler animationHandler = new Handler() { // from class: com.jzxiang.pickerview.wheel.WheelScroller.1
    ...
    private GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() { // from class: com.jzxiang.pickerview.wheel.WheelScroller.2
