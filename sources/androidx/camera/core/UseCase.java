...
public abstract class UseCase {
    ...
    public UseCaseConfig<?> mergeConfigs(CameraInfoInternal cameraInfoInternal, UseCaseConfig<?> useCaseConfig, UseCaseConfig<?> useCaseConfig2) {
        ...
        if (create.containsOption(ImageOutputConfig.OPTION_RESOLUTION_SELECTOR) && ((ResolutionSelector) create.retrieveOption(ImageOutputConfig.OPTION_RESOLUTION_SELECTOR)).isHighResolutionEnabled()) {
