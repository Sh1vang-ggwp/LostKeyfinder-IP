...
public final class SurfaceRequest {
    ...
    public SurfaceRequest(Size size, CameraInternal cameraInternal, Range<Integer> range, Runnable runnable) {
        ...
        terminationFuture.addListener(new Runnable() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceRequest.this.m125lambda$new$3$androidxcameracoreSurfaceRequest();
            }
        }, CameraXExecutors.directExecutor());
    ...
    /* synthetic */ void m125lambda$new$3$androidxcameracoreSurfaceRequest() {
    ...
    private CallbackToFutureAdapter.Completer<Void> initialSurfaceRecreationCompleter(Executor executor, final Runnable runnable) {
        final AtomicReference atomicReference = new AtomicReference(null);
        Futures.addCallback(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return SurfaceRequest.this.m124xee56265b(atomicReference, completer);
            }
    ...
    /* synthetic */ Object m124xee56265b(AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) throws Exception {
        atomicReference.set(completer);
    ...
    public static abstract class TransformationInfo {
        ...
        public static TransformationInfo of(Rect rect, int i, int i2, boolean z) {
            return new AutoValue_SurfaceRequest_TransformationInfo(rect, i, i2, z);
        }
