...
public final class ImageAnalysis extends UseCase {
    ...
    /* JADX WARN: Type inference failed for: r5v10, types: [androidx.camera.core.impl.UseCaseConfig] */
    ...
    protected UseCaseConfig<?> onMergeConfig(CameraInfoInternal cameraInfoInternal, UseCaseConfig.Builder<?, ?, ?> builder) {
        ...
        if (defaultTargetResolution != null) {
            if (!builder.getMutableConfig().containsOption(ImageOutputConfig.OPTION_RESOLUTION_SELECTOR)) {
                ...
                ResolutionSelector resolutionSelector = (ResolutionSelector) builder.getMutableConfig().retrieveOption(ImageOutputConfig.OPTION_RESOLUTION_SELECTOR);
    ...
    SessionConfig.Builder createPipeline(final String str, final ImageAnalysisConfig imageAnalysisConfig, final Size size) {
        ...
        createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda1
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                ImageAnalysis.this.m104lambda$createPipeline$1$androidxcameracoreImageAnalysis(str, imageAnalysisConfig, size, sessionConfig, sessionError);
            }
        });
        return createFrom;
    }
    ...
    /* synthetic */ void m104lambda$createPipeline$1$androidxcameracoreImageAnalysis(String str, ImageAnalysisConfig imageAnalysisConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
