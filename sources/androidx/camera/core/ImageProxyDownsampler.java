        ...
        synchronized (byteBuffer) {
            ...
            while (i9 < i6) {
                ...
                for (int i13 = 0; i13 < i5; i13++) {
                    bArr[i12 + i13] = (byte) ((((((bArr2[iArr[i13]] & UByte.MAX_VALUE) + (bArr2[iArr[i13] + i2] & UByte.MAX_VALUE)) + (bArr3[iArr[i13]] & UByte.MAX_VALUE)) + (bArr3[iArr[i13] + i2] & UByte.MAX_VALUE)) / 4) & 255);
                }
                i9++;
                i7 = 0;
            }
