...
public class DefaultSurfaceProcessor implements SurfaceProcessorInternal, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onInputSurface(final SurfaceRequest surfaceRequest) {
        if (this.mIsReleased.get()) {
            ...
            this.mGlExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    DefaultSurfaceProcessor.this.m151xeeb3c23e(surfaceRequest);
                }
            });
        }
    }
    ...
    /* synthetic */ void m151xeeb3c23e(SurfaceRequest surfaceRequest) {
        ...
        surfaceRequest.provideSurface(surface, this.mGlExecutor, new Consumer() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda1
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                DefaultSurfaceProcessor.this.m150xc91fb93d(surfaceTexture, surface, (SurfaceRequest.Result) obj);
            }
        });
    ...
    /* synthetic */ void m150xc91fb93d(SurfaceTexture surfaceTexture, Surface surface, SurfaceRequest.Result result) {
    ...
    public void onOutputSurface(final SurfaceOutput surfaceOutput) {
        if (this.mIsReleased.get()) {
            ...
            this.mGlExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    DefaultSurfaceProcessor.this.m153x7933371(surfaceOutput);
                }
            });
        }
    }
    ...
    /* synthetic */ void m153x7933371(final SurfaceOutput surfaceOutput) {
        Surface surface = surfaceOutput.getSurface(this.mGlExecutor, new Consumer() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda2
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                DefaultSurfaceProcessor.this.m152xe1ff2a70(surfaceOutput, (SurfaceOutput.Event) obj);
            }
        });
    ...
    /* synthetic */ void m152xe1ff2a70(SurfaceOutput surfaceOutput, SurfaceOutput.Event event) {
        surfaceOutput.close();
        ...
        try {
            CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return DefaultSurfaceProcessor.this.m149xbd488fb8(shaderProvider, completer);
                }
            }).get();
    ...
    /* synthetic */ Object m149xbd488fb8(final ShaderProvider shaderProvider, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mGlExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.DefaultSurfaceProcessor$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                DefaultSurfaceProcessor.this.m148x97b486b7(shaderProvider, completer);
            }
        });
    ...
    /* synthetic */ void m148x97b486b7(ShaderProvider shaderProvider, CallbackToFutureAdapter.Completer completer) {
        try {
