...
public class InternalImageProcessor {
        ...
        try {
            return (ImageProcessor.Response) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.InternalImageProcessor$$ExternalSyntheticLambda0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return InternalImageProcessor.this.m155xe9947096(request, completer);
                }
            }).get();
    ...
    /* synthetic */ Object m155xe9947096(final ImageProcessor.Request request, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.InternalImageProcessor$$ExternalSyntheticLambda1
            ...
            public final void run() {
                InternalImageProcessor.this.m154xe85e1db7(completer, request);
            }
        });
    ...
    /* synthetic */ void m154xe85e1db7(CallbackToFutureAdapter.Completer completer, ImageProcessor.Request request) {
        try {
