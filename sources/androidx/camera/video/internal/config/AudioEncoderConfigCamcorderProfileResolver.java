...
public final class AudioEncoderConfigCamcorderProfileResolver implements Supplier<AudioEncoderConfig> {
    ...
    public AudioEncoderConfigCamcorderProfileResolver(String str, int i, Timebase timebase, AudioSpec audioSpec, AudioSource.Settings settings, CamcorderProfileProxy camcorderProfileProxy) {
        this.mMimeType = str;
