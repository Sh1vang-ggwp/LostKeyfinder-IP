...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    private ListenableFuture<Void> waitForSessionUpdateId(final long j) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda4
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraControlImpl.this.m7x20143706(j, completer);
            }
        });
    }
    ...
    /* synthetic */ Object m7x20143706(final long j, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(final List<CaptureConfig> list, final int i, final int i2) {
        ...
        return FutureChain.from(Futures.nonCancellationPropagating(this.mFlashModeChangeSessionUpdateFuture)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda2
            ...
            public final ListenableFuture apply(Object obj) {
                return Camera2CameraControlImpl.this.m4xd133171b(list, i, flashMode, i2, (Void) obj);
            }
        }, this.mExecutor);
    }
    ...
    /* synthetic */ ListenableFuture m4xd133171b(List list, int i, int i2, int i3, Void r5) throws Exception {
    ...
    ListenableFuture<Void> updateSessionConfigAsync() {
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda3
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraControlImpl.this.m6x6775df50(completer);
            }
        }));
    }
    ...
    /* synthetic */ Object m6x6775df50(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m5x56c0128f(completer);
            }
        });
    ...
    /* synthetic */ void m5x56c0128f(CallbackToFutureAdapter.Completer completer) {
    ...
    void addSessionCameraCaptureCallback(final Executor executor, final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m1x48c3417b(executor, cameraCaptureCallback);
            }
        });
    }
    ...
    /* synthetic */ void m1x48c3417b(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    void removeSessionCameraCaptureCallback(final CameraCaptureCallback cameraCaptureCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraControlImpl.this.m3xd0890cf9(cameraCaptureCallback);
            }
        });
    }
    ...
    /* synthetic */ void m3xd0890cf9(CameraCaptureCallback cameraCaptureCallback) {
    ...
    static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureCompleted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, final TotalCaptureResult totalCaptureResult) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraControlImpl$CameraControlSessionCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraControlImpl.CameraControlSessionCallback.this.m8xf57ef947(totalCaptureResult);
                }
            });
        }
        ...
        /* synthetic */ void m8xf57ef947(TotalCaptureResult totalCaptureResult) {
