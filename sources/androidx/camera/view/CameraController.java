...
public abstract class CameraController {
    ...
    CameraController(Context context) {
        ...
        this.mInitializationFuture = Futures.transform(ProcessCameraProvider.getInstance(applicationContext), new Function() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return CameraController.this.m218lambda$new$0$androidxcameraviewCameraController((ProcessCameraProvider) obj);
            }
        ...
        this.mDeviceRotationListener = new RotationProvider.Listener() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda1
            ...
            public final void onRotationChanged(int i) {
                CameraController.this.m219lambda$new$1$androidxcameraviewCameraController(i);
            }
        };
    }

    /* renamed from: lambda$new$0$androidx-camera-view-CameraController, reason: not valid java name */
    /* synthetic */ Void m218lambda$new$0$androidxcameraviewCameraController(ProcessCameraProvider processCameraProvider) {
    ...
    /* synthetic */ void m219lambda$new$1$androidxcameraviewCameraController(int i) {
    ...
    public void takePicture(ImageCapture.OutputFileOptions outputFileOptions, Executor executor, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
        ...
        this.mImageCapture.m112lambda$takePicture$3$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
    }
    ...
    public void takePicture(Executor executor, ImageCapture.OnImageCapturedCallback onImageCapturedCallback) {
        ...
        Preconditions.checkState(isCameraInitialized(), CAMERA_NOT_INITIALIZED);
        Preconditions.checkState(isImageCaptureEnabled(), IMAGE_CAPTURE_DISABLED);
        this.mImageCapture.m111lambda$takePicture$2$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
    }
    ...
    class AnonymousClass1 implements Consumer<VideoRecordEvent> {
            ...
            if (videoRecordEvent instanceof VideoRecordEvent.Finalize) {
                if (!Threads.isMainThread()) {
                    this.val$mainExecutor.execute(new Runnable() { // from class: androidx.camera.view.CameraController$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraController.AnonymousClass1.this.m222lambda$accept$0$androidxcameraviewCameraController$1();
                        }
                    });
                } else {
        ...
        /* synthetic */ void m222lambda$accept$0$androidxcameraviewCameraController$1() {
            CameraController.this.deactivateRecordingByListener(this);
        }
    }
    ...
    public void setVideoCaptureTargetQuality(Quality quality) {
        Threads.checkMainThread();
    ...
    public void setCameraSelector(CameraSelector cameraSelector) {
        ...
        startCameraAndTrackStates(new Runnable() { // from class: androidx.camera.view.CameraController$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                CameraController.this.m220lambda$setCameraSelector$3$androidxcameraviewCameraController(cameraSelector2);
            }
        });
    }

    /* renamed from: lambda$setCameraSelector$3$androidx-camera-view-CameraController, reason: not valid java name */
    /* synthetic */ void m220lambda$setCameraSelector$3$androidxcameraviewCameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
    ...
    protected UseCaseGroup createUseCaseGroup() {
        ...
        if (isVideoCaptureEnabled()) {
            VideoCapture<Recorder> createNewVideoCapture = createNewVideoCapture();
            this.mVideoCapture = createNewVideoCapture;
            addUseCase.addUseCase(createNewVideoCapture);
        }
